import { Hero,Footer,CustomerReviews,SpecialOffer,SupperQuality,Subscribe,Services,PopularProduct} from './sections'
...
const App = () => (
  <main className="relative">
    ...
    <section className=" bg-gray-700 padding-x padding-t pb-8"><Footer/></section>
  </main>
);
export default App;
